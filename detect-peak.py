...
# #excel_file_path = './Atapy-project-SR-Burapa/Atapy-project-SR-Burapa/excel/' + f'{file_name}.x
...
min_height = avg_before #- (avg_before *0.3)
max_height = avg_before + (avg_before *0.25)
